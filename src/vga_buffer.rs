...
impl ColorCode {
    fn new(fg: Color, bg: Color) -> ColorCode {
        ColorCode((((bg as u8) & 0xf) << 4) | (fg as u8))
    }
}
...
//     writer.write_string("The first byte represents the character that should be printed in the ASCII encoding. To be more specific, it isn't exactly ASCII, but a character set named code page 437 with some additional characters and slight modifications. For simplicity, we will proceed to call it an ASCII character in this post.
...
//     writeln!(writer, "Formatted writing {} and {}", 63, 3.4 / 7.8).unwrap();
//     writeln!(writer, "Formatted writing {} and {}", 63, 3 / 5.0).unwrap();
// }
